    ...
    <main className="flex-grow py-8 px-4 sm:px-6 lg:px-8 bg-[var(--color-background)]">
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <EducationSection
          ...
          educationDegree={controller.educationDegree}
          setEducationDegree={controller.setEducationDegree}
          educationFieldOfStudy={controller.educationFieldOfStudy}
          setEducationFieldOfStudy={controller.setEducationFieldOfStudy}
          educationStartDate={controller.educationStartDate}
          setEducationStartDate={controller.setEducationStartDate}
          educationEndDate={controller.educationEndDate}
          setEducationEndDate={controller.setEducationEndDate}
          educationGrade={controller.educationGrade}
          setEducationGrade={controller.setEducationGrade}
          educationDescription={controller.educationDescription}
          setEducationDescription={controller.setEducationDescription}
        ...
        <ExperienceSection
          ...
          experienceLocation={controller.experienceLocation}
          setExperienceLocation={controller.setExperienceLocation}
          experienceStartDate={controller.experienceStartDate}
          setExperienceStartDate={controller.setExperienceStartDate}
          experienceEndDate={controller.experienceEndDate}
          setExperienceEndDate={controller.setExperienceEndDate}
          experienceCurrentlyWorking={controller.experienceCurrentlyWorking}
          setExperienceCurrentlyWorking={controller.setExperienceCurrentlyWorking}
          experienceDescription={controller.experienceDescription}
          setExperienceDescription={controller.setExperienceDescription}
