...
public record GraduateQueryInterpretation(
    ...
    /** Compatibility constructor for callers that predate comparison dimensions. */
    public GraduateQueryInterpretation(
            ...
            String aggregation, String thresholdOperator, String thresholdValue, String currency,
            String billingBasis, String academicYear, String tuitionScopeLevel, String sortField,
        ...
        this(schemaVersion, intent, universities, degreeTypes, detailLevel, followUp, comparison, topicKeywords,
                ...
                languages, admissionRequirementTypes, programName, aggregation, thresholdOperator, thresholdValue,
                currency, billingBasis, academicYear, tuitionScopeLevel, sortField, sortDirection, limit, null);
    }
