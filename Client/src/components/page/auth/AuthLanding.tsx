    ...
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center bg-[var(--color-background)] py-12 px-4">
      ...
      >
        ...
        <motion.div 
          ...
          className="hidden lg:flex flex-col items-center justify-center bg-[var(--color-authPanel)] p-8 relative"
        >
          <div className="z-10 text-center text-[var(--color-primary)]">
            <svg
            ...
            <h2 className="text-3xl font-black tracking-tight text-[var(--color-primary)] opacity-90 mb-4">
              Why You Must Log In?
            </h2>
            <p className="text-base text-[var(--color-primary)] opacity-80">
