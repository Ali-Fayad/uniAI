  ...
  return (
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center bg-custom-light py-12 px-4">
      <div className="grid grid-cols-1 lg:grid-cols-3 w-full max-w-6xl min-h-[600px] rounded-3xl overflow-hidden shadow-2xl">
        ...
        <div className="hidden lg:flex flex-col items-center justify-center bg-custom-accent p-8 relative">
          <div className="z-10 text-center text-[#151514]">
            <svg
              className="mx-auto h-12 w-auto text-[#B6AE9F] mb-6"
              fill="currentColor"
              viewBox="0 0 54 44"
            ...
            <h2 className="text-3xl font-black tracking-tight text-[#151514]/80 mb-4">
              Why You Must Log In?
            </h2>
            <p className="text-base text-[#151514]/60">
        ...
        <div className="col-span-1 lg:col-span-2 flex flex-col items-center justify-center p-6 sm:p-12 bg-white/50 backdrop-blur-sm">
          <div className="w-full max-w-md">
            ...
            <div className="space-y-4">
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="bg-white/50 px-2 text-[#797672]">or continue with</span>
                </div>
              </div>
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="flex w-full items-center justify-center gap-2 rounded-full border border-custom-secondary/50 bg-white h-12 text-[#151514] font-medium hover:bg-gray-50 transition disabled:opacity-50 disabled:cursor-not-allowed"
                >
